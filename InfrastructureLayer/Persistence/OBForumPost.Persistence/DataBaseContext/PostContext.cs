...
namespace OBForumPost.Persistence.DataBaseContext
{
    public sealed class PostContext : DbContext
    {
        public static string ConnectionString
            => $"Server={Environment.GetEnvironmentVariable("DB_SERVERNAME")};Port={Environment.GetEnvironmentVariable("DB_PORT")};Database=post;User Id={Environment.GetEnvironmentVariable("DB_USERID")};Password={Environment.GetEnvironmentVariable("DB_PASSWORD")};";
